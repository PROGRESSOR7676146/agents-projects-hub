...
from .acceptance_runtime import (
    AcceptanceRuntimeError as _AcceptanceRuntimeError,
)
from .acceptance_runtime import (
...
from .acceptance_runtime import (
    ServiceSnapshot as _ServiceSnapshot,
)
from .p0_p1_acceptance import (
    P0_P1_CHECKS as _P0_P1_CHECKS,
)
from .p0_p1_acceptance import (
    P0P1ScenarioContext as _P0P1ScenarioContext,
)
from .p0_p1_acceptance import (
    run_p0_p1_live_scenario as _run_p0_p1_live_scenario,
)

AcceptanceRuntimeError = _AcceptanceRuntimeError
P0_P1_CHECKS = _P0_P1_CHECKS
ServiceSnapshot = _ServiceSnapshot
...
async def _run_p0_p1_live_checks(
    ...
    context = _P0P1ScenarioContext(
        client=client,
        config=config,
        state_probe=ReadOnlyAcceptanceState(config.state_path),
        service_supervisor=FixedServiceSupervisor(),
    )
    return await _run_p0_p1_live_scenario(context, target)
