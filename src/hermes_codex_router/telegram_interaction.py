...
- For substantial work with findings or changes worth reviewing, you may attach a concise Markdown final report from that directory. Do not follow a fixed template: choose the report structure for the actual result. Use tables, diagrams, or images when they clarify it; attach real screenshots only when available and relevant, never fabricate evidence. Keep visuals readable on a phone. Do not repeat progress notes or the chat answer; simple work needs only a short answer, without a report.
