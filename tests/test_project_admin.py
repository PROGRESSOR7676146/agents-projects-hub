...
class ProjectAdminTests(unittest.TestCase):
    ...
    def test_add_and_disable_project_locally(self) -> None:
        ...
        self.assertTrue(load_registry(self.registry).require_project("pythia").enabled)
        set_project_enabled(self.registry, "pythia", False)
        with self.assertRaises(KeyError):
            load_registry(self.registry).require_project("pythia")
