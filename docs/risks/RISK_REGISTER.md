...
| R-002 | Wrong agent answers or idle providers spend tokens | Central deterministic ingress, Reply/mention precedence, provider pollers disabled, bounded journal | Complete Hub General live E2E and observe provider invocation metadata. |
