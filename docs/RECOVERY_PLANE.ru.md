...
запрещены. Используются только локально allowlisted account profiles; их имена
и email не записываются в Git. Автоматизацию добавлять после capability probe новой версии
